...
simple control files.  I'll illustrate how Hoffman works using these
examples.
...
{\small\begin{verbatim}
C> hoffman -i kqk.htb
Hoffman $Revision: 1.4 $ $Locker: baccala $
...
<tablebase offset="0x0fe4">
   ...
   <generation-statistics>
      ...
      <program>Hoffman $Revision: 1.4 $ $Locker: baccala $</program>
