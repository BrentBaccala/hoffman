...
tablebase_t * parse_XML_into_tablebase(xmlDocPtr doc, bool is_futurebase)
{
	...
	for (piece = 0; piece < tb->num_pieces; piece ++) {
	     ...
	     *
	     * We never assign a "last overlapping piece" to a pawn because of the difficulty in
...
tablebase_t * parse_XML_control_file(char *filename)
{
    ...
    xmlNodeSetContent(create_GenStats_node("program"), BAD_CAST "Hoffman $Revision: 1.731 $ $Locker: baccala $");
...
int main(int argc, char *argv[])
{
    ...
    fprintf(stderr, "Hoffman $Revision: 1.731 $ $Locker: baccala $\n");
